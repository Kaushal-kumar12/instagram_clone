...
const FollowersList = () => {
  ...
  useEffect(() => {
    const fetchFollowers = async () => {
      try {
        const res = await axios.get(`https://instagram-clone-e205.onrender.com/api/v1/user/${id}/followers`, { withCredentials: true });
  ...
  const handleFollowToggle = async (targetUserId) => {
    try {
      await axios.post(`https://instagram-clone-e205.onrender.com/api/v1/user/followorunfollow/${targetUserId}`, {}, { withCredentials: true });
