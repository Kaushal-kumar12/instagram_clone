...
const FollowingList = () => {
  ...
  useEffect(() => {
    const fetchFollowing = async () => {
      try {
        const res = await axios.get(`https://instagram-clone-te4g.onrender.com/api/v1/user/${id}/following`, { withCredentials: true });
  ...
  const handleFollowToggle = async (targetUserId) => {
    try {
      await axios.post(`https://instagram-clone-te4g.onrender.com/api/v1/user/followorunfollow/${targetUserId}`, {}, { withCredentials: true });
